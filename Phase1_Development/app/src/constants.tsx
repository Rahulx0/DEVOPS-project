// Icon components used throughout the app
import React from 'react';

// Props type for SVG icons
type IconProps = React.SVGProps<SVGSVGElement>;

// Shopping cart SVG icon
export const ShoppingCartIcon: React.FC<IconProps> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 3h1.386c.51 0 .955.343 1.087.835l.383 1.437M7.5 14.25a3 3 0 00-3 3h15.75m-12.75-3h11.218c.51 0 .962-.328 1.095-.826l1.724-6.897c.063-.252.093-.514.093-.777 0-.432-.146-.856-.436-1.182A2.25 2.25 0 0018.75 3H5.25m0 0l-1.09-4.152A.75.75 0 003.39 2.25H1.5M7.5 14.25h11.218M14.25 10.5h4.5m-4.5-3h4.5m-13.5 3h4.5m-4.5-3h4.5" />
  </svg>
);

// Heart (wishlist/favorite) SVG icon
